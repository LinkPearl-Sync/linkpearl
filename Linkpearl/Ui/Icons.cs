...
internal static class Icons
{
    ...
    public const FontAwesomeIcon Expanded  = FontAwesomeIcon.ChevronDown;
    public const FontAwesomeIcon Collapsed = FontAwesomeIcon.ChevronRight;
    ...
    [
        ...
        Moderator, Admission, Expanded, Collapsed,
        Warning, Info, Empty,
        Folder, Lock, Check,
    ];
}
